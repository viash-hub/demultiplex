...
* Allow processing multiple inputs with one workflow run (PR #). 

## Bug fixes

* Avoid errors when the input channel is empty. This is useful when the workflow is used as a subworkflow (PR #). 
